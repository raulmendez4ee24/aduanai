/**
 * Seed: Reglas de origen — TMEC (T-MEC/USMCA), TLCUEM, CPTPP.
 *
 * Cobertura prioritaria del TMEC (Anexo 4-B automotriz, textiles yarn-forward,
 * acero melt-and-pour, electrónicos cambio de partida + RVC).
 *
 * Las reglas son simplificaciones documentadas — la regla específica vinculante
 * está en el Anexo 4-B del TMEC (vigente desde 2020-07-01) y debe consultarse
 * para casos específicos. Aquí se cargan las reglas más comunes con descripción
 * legible para el usuario y los datos clave para el cálculo automático (RVC,
 * tariffShift).
 */
...
export const ORIGIN_RULES: OriginRuleSeed[] = [
  ...
  { fractionCode: '8544', matchType: 'prefix', agreement: 'TMEC', ruleType: 'combined',
    description: 'Cables y arneses — cambio de partida + RVC',
    tariffShift: 'Cambio a 8544 desde cualquier otra partida',
    rvcRequired: 60, rvcMethod: 'transaction_value',
    notes: 'Arneses automotrices son sensibles — verificar Anexo 4-B si destino automotriz.' },
