 ...
 * FUENTE OFICIAL: Anexo 10 de las RGCE para 2026, DOF 14 de enero de 2026
 * (cotejado 2026-07-03 contra el PDF oficial: composición y nombres de los 16
 * sectores IDÉNTICOS a la versión DOF 19-ene-2024; solo cambia la publicación vigente).
...
const SEEDS: PadronSeed[] = [
  ...
  // 14 de enero de 2026 (RGCE 2026). Numeración y nombres TEXTUALES del Anexo.
  ...
  // cobertura completa por fracción del Anexo 10 está pendiente (ver DEFERRED_WORK).
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 1 (DOF 14-ene-2026)', authority: 'SAT-AGACE',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 2 (DOF 14-ene-2026)', authority: 'SAT-AGACE + CNSNS',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 3 (DOF 14-ene-2026) · Ley General de Salud', authority: 'SAT-AGACE + COFEPRIS',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 4 (DOF 14-ene-2026) · Ley Federal de Armas de Fuego', authority: 'SAT-AGACE + SEDENA',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 5 (DOF 14-ene-2026)', authority: 'SAT-AGACE + SEDENA',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 6 (DOF 14-ene-2026)', authority: 'SAT-AGACE + SEDENA',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 7 (DOF 14-ene-2026)', authority: 'SAT-AGACE + SEDENA',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 8 (DOF 14-ene-2026)', authority: 'SAT-AGACE + SEDENA',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 9 (DOF 14-ene-2026) · LIEPS', authority: 'SAT-AGACE',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 10 (DOF 14-ene-2026)', authority: 'SAT-AGACE',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 11 (DOF 14-ene-2026)', authority: 'SAT-AGACE',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 12 (DOF 14-ene-2026)', authority: 'SAT-AGACE',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 13 (DOF 14-ene-2026) · Ley de Hidrocarburos', authority: 'SAT-AGACE + CRE',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 14 (DOF 14-ene-2026)', authority: 'SAT-AGACE',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 15 (DOF 14-ene-2026)', authority: 'SAT-AGACE',
  ...
  },
  {
    ...
    legalBasis: 'Anexo 10 RGCE Sector 16 (DOF 14-ene-2026)', authority: 'SAT-AGACE',
