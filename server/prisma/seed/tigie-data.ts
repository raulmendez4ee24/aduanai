...
export const FRACTIONS = [
  ...
  { code: '04069099', formatted: '0406.90.99', description: 'Los demás quesos', chapter: '04', heading: '0406', subheading: '040690', unit: 'Kg', tariffNMF: 20, tariffTMEC: 0, keywords: ['queso', 'cheese', 'lácteo'], noms: ['NOM-121-SSA1-1994'], requiresPermit: false, sectoralRegistry: true, sectoralType: 'Padrón Sectorial de Importadores - Sector 10' },
