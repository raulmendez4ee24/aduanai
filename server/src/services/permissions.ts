...
export const SYSTEM_ROLES: RoleSeed[] = [
  {
    ...
    permissions: {
      modules: {
        ...
        fiscalGuardian: { view: true, create: true, delete: true, generateReport: true, acknowledgeAlert: true },
        ...
        calendario: { view: true, create: true, approve: true, delete: true, generateReport: true, acknowledgeAlert: true },
  ...
  },
  {
    ...
    permissions: {
      modules: {
        ...
        fiscalGuardian: { view: true, create: false, delete: false, generateReport: false, acknowledgeAlert: false },
  ...
  },
  {
    ...
    permissions: {
      modules: {
        ...
        fiscalGuardian: { view: true, create: false, delete: false, generateReport: false, acknowledgeAlert: true },
        payment: { view: false, authorize: false },
  ...
  },
  {
    ...
    permissions: {
      modules: {
        ...
        fiscalGuardian: { view: true, create: true, delete: true, generateReport: true, acknowledgeAlert: false },
        payment: { view: true, authorize: true },
  ...
  },
  {
    ...
    permissions: {
      modules: {
        ...
        fiscalGuardian: { view: true, create: false, delete: false, generateReport: true, acknowledgeAlert: false },
  ...
  // "El junior propone, el señor con patente aprueba": CAPTURISTA crea, no aprueba.
  {
    ...
    permissions: {
      modules: {
        ...
        inventory: { view: true, adjust: false, discharge: false },
        expedientes: { view: true, create: true, sign: false, archive: false },
        fiscalGuardian: { view: true, create: true, delete: false, generateReport: false, acknowledgeAlert: false },
        payment: { view: false, authorize: false },
        preglosa: { view: true, create: true, approve: false, archive: false },
        risk: { view: true, create: true, generateReport: false },
        origin: { view: true, create: true, approve: false },
  ...
  },
  {
    ...
    permissions: {
      modules: {
        ...
        fiscalGuardian: { view: true, create: true, delete: true, generateReport: false, acknowledgeAlert: true },
        payment: { view: false, authorize: false },
        preglosa: { view: true, create: true, approve: true, archive: true },
        risk: { view: true, create: true, generateReport: false },
        origin: { view: true, create: false, approve: true },
  ...
  },
  {
    ...
    permissions: {
      modules: {
        ...
        calendario: { view: true, create: true, approve: true, generateReport: true, acknowledgeAlert: true },
