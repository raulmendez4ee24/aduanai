...
export const RULES_VERSION = 'v1.0.0-2026-07-04';
...
export const RISK_RULES: RiskRule[] = [
  ...
  },
  {
    ...
    descripcion: 'Manifestación de valor (formato E2) no transmitida por Ventanilla Digital',
    evaluar: s => (noConfirmado(s.declarado.mveTransmitida) ? 8 : 0),
    fundamento: { articulo: 'LA 59-III + RGCE 1.5.1', citaCorta: '"Transmitir a través de la Ventanilla Digital, el formato E2 \'Manifestación de Valor\'… por cada operación de comercio exterior."', ...RGCE },
  },
  {
