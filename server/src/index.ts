...
import { cotejoRouter } from './routes/cotejo'; // fix/deuda-de-cotejo — tablero de deuda de cotejo
...
app.use('/api/admin/cotejo', cotejoRouter); // fix/deuda-de-cotejo — tablero + cargadores
