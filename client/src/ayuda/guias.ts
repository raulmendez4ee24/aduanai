...
export const GUIAS: Record<string, GuiaModulo> = {
  ...
  '/cotizador': G('cotizador', 'Cotizador', 'Desglose de impuestos y costo de despacho por partida, con escenarios.',
    ['Captura partidas (fracción, origen, valor, flete, seguro).', 'El sistema aplica IGI/IVA/IEPS, DTA por tipo de operación, cuotas compensatorias detectadas y honorarios del tabulador.', 'Guarda, duplica y versiona por cliente; compara escenarios (definitivo vs T-MEC vs PROSEC).', 'Exporta PDF con logo, vigencia y fecha DOF del tipo de cambio.']),
  ...
  '/cuotas-activas': G('cuotas', 'Cuotas compensatorias', 'Resoluciones vigentes con tasas por exportador y vigencias.',
    ['Busca por fracción y país; revisa la tasa por empresa cuando la resolución la fija.', 'Las resoluciones antielusión disparan alerta en Pre-Glosa y Cotizador.']),
  ...
  '/biblioteca-legal': G('biblioteca', 'Biblioteca legal', 'El corpus que respalda al Copilot, con fecha de cotejo.',
    ['Cada documento indica fuente, versión y si es texto íntegro o resumen.']),
